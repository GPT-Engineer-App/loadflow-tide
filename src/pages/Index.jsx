    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>
              Dogs are domesticated mammals, part of the wolf family. They have been bred by humans for a long time, and were the first animals to be domesticated. Dogs are often called "man's best friend" because they are kept as pets and companions.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <ul className="list-disc pl-6">
              ...
              <li>Can be working animals or beloved pets</li>
            </ul>
          </CardContent>
        </Card>
